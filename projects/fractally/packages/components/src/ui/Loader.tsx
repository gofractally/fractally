...
const LoadingIcon = ({ size }: { size?: number }) => {
  return (
    <svg className="animate-spin mr-2 text-gray-700" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" viewBox="0 0 32 32">
